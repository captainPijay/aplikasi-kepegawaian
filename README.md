# Aplikasi Kepegawaian Internal Kesehatan Bengkulu Utara
...
1. **Clone Project**
    ...
    - Clone project dari repository dengan menggunakan perintah berikut:
        ```bash
        git clone https://github.com/PerdanaKarya/aplikasi-kepegawaian-internal-kesehatan-bengkulu-utara.git
        ```
