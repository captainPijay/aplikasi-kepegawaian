                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="select-container">
                                    ...
                                    <select id="selectInput" class="form-select mb-0" name="jenis" id="jenis" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="readonlyInput" placeholder="DD/MM/YY" value="{{ old('cuti_time') }}" name="cuti_time" type="text"
                                    class="form-control readOnlyInput {{ $errors->has('cuti_time') ? 'border-danger' : 'border-none' }}"
                                    required readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input name="lampiran" type="file" accept=".pdf" class="form-control {{ $errors->has('lampiran') ? 'border-danger' : 'border-none' }}" required>
...
$('#selectInput').change(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            $('#readonlyInput').val(response.cutiTime);
        },
