    ...
    function loadData(){
        $('#serverSide').DataTable({
            ...
            initComplete: function () {
                ...
                var infoSection = $(
                    '<div class="icon-info"><i class="ri-building-4-line"></i></div><div class="text-info"><span>Total Data Instansi</span><h5>0</h5></div>'
                );
