...
<div class="container-fluid bg-white wrapperDataTableBackOffice">
    ...
    @include('back_office.satuan_kerja.modal_tambah')
    @include('back_office.satuan_kerja.modal_edit')
@endsection
...
<script type="text/javascript">
    ...
    function loadData(){
        $('#serverSide').DataTable({
            ...
            columns:[
                ...
                {
                    data: 'satuan_kerja_induk_name',
                    name: 'satuan_kerja_induk_name',
                    searchable: true
                },
                {
                    data: 'name',
            ...
            initComplete: function () {
                ...
                var infoSection = $(
                    '<div class="icon-info"><i class="ri-building-4-line"></i></div><div class="text-info"><span>Total Data Satuan Kerja</span><h5>0</h5></div>'
                );
    ...
    function editData({id, name, satuan_kerja_induk_id}) {
        $("#formEdit input[name='name']").val(name);
        $("#formEdit select[name='satuan_kerja_induk_id']").val(satuan_kerja_induk_id);
