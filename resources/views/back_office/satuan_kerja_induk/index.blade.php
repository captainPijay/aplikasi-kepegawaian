...
<script type="text/javascript">
    ...
    function loadData(){
        $('#serverSide').DataTable({
            ...
            ordering: false,
            ajax:{
                url: "{{ route('satuanKerjaInduk.index') }}"
            },
            columns:[
                {
                    data: 'id',
            ...
            initComplete: function () {
                ...
                var infoSection = $(
                    '<div class="icon-info"><i class="ri-building-4-line"></i></div><div class="text-info"><span>Total Data Satuan Kerja Induk</span><h5>0</h5></div>'
                );
