...
<div class="container-fluid bg-white wrapperDataTableBackOffice">
    ...
    @include('back_office.anak.modal_tambah')
    @include('back_office.anak.modal_edit')
@endsection
...
<script type="text/javascript">
    ...
    function editData({id,pegawai_id,children_name,latest_education,job,status}) {
        $("#formEdit input[name='id']").val(id);
        $("#formEdit select[name='pegawai_id']").val(pegawai_id);
        $("#formEdit input[name='children_name']").val(children_name);
