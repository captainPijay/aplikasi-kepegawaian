...
<div class="container-fluid bg-white formPegawaiContainer">
    ...
    <form action="{{ route($updateUrl,$id) }}" class="wrapperForm" method="POST" id="formData" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('name',$pegawaiData->name) }}" name="name" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="employee_type" id="employee_type" >
                                ...
                                <option value="PNS" {{ old('employee_type',$pegawaiData->employee_type) == 'PNS' ? 'selected' : '' }}>PNS</option>
                                <option value="PPPK" {{ old('employee_type',$pegawaiData->employee_type) == 'PPPK' ? 'selected' : '' }}>PPPK</option>
                                <option value="Non ASN" {{ old('employee_type',$pegawaiData->employee_type) == 'Non ASN' ? 'selected' : '' }}>Non ASN</option>
                                @error('employee_type')
                                <div class="text-danger">
                                    <span>{{ $message }}</span>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('gelar_depan',$pegawaiData->gelar_depan) }}" name="gelar_depan" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('gelar_belakang',$pegawaiData->gelar_belakang) }}" name="gelar_belakang" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('place_of_birth',$pegawaiData->place_of_birth) }}" name="place_of_birth" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('date_of_birth',$pegawaiData->date_of_birth) }}" name="date_of_birth" type="date"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="gender" id="gender" >
                                ...
                                <option value="Laki-Laki" {{ old('gender',$pegawaiData->gender) == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                                <option value="Perempuan" {{ old('gender',$pegawaiData->gender) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="religion" id="religion" >
                                ...
                                <option value="Islam" {{ old('religion',$pegawaiData->religion) == 'Islam' ? 'selected' : '' }}>Islam</option>
                                <option value="Kristen" {{ old('religion',$pegawaiData->religion) == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                <option value="Katolik" {{ old('religion',$pegawaiData->religion) == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                <option value="Hindu" {{ old('religion',$pegawaiData->religion) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                <option value="Budha" {{ old('religion',$pegawaiData->religion) == 'Budha' ? 'selected' : '' }}>Budha</option>
                                <option value="Kong Hu Cu" {{ old('religion',$pegawaiData->religion) == 'Kong Hu Cu' ? 'selected' : '' }}>Kong Hu Cu</option>
                                <option value="Lainnya" {{ old('religion',$pegawaiData->religion) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="married_type" id="married_type">
                                ...
                                <option value="Menikah" {{ old('married_type',$pegawaiData->married_type) == 'Menikah' ? 'selected' : '' }}>Menikah</option>
                                <option value="Belum Menikah" {{ old('married_type',$pegawaiData->married_type) == 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="nik_number" value="{{ old('nik_number',$pegawaiData->nik_number) }}" name="nik_number" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('phone_number',$pegawaiData->phone_number) }}" name="phone_number" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('email',$pegawaiData->email) }}" name="email" type="email"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('address',$pegawaiData->address) }}" name="address" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('npwp_number',$pegawaiData->npwp_number) }}" name="npwp_number" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('bpjs_number',$pegawaiData->namebpjs_number) }}" name="bpjs_number" type="text"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('username',$pegawaiData->username) }}" name="username" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('old_username',$pegawaiData->old_username) }}" name="old_username" type="text"
                    ...
                    <div class="col-sm-6 pppkDetails" style="display:none">
                        <div class="form-group">
                            ...
                            <input value="{{ old('sk_pppk_date',$pegawaiData->sk_pppk_date) }}" name="sk_pppk_date" type="date"
                    ...
                    <div class="col-sm-6 pppkDetails" style="display:none">
                        <div class="form-group">
                            ...
                            <input value="{{ old('sk_pppk_date_end',$pegawaiData->sk_pppk_date_end) }}" name="sk_pppk_date_end" type="date"
                    ...
                    <div class="col-sm-6 pppkDetails" style="display:none">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="golongan_awal_pppk" id="golongan_awal_pppk">
                                ...
                                @for ($i = 5; $i <= 12; $i++)
                                <option value="{{ $i }}" {{ old('golongan_awal_pppk',$pegawaiData->golongan_awal_pppk) == $i ? 'selected' : '' }}>{{ $i }}</option>
                                @endfor
                    ...
                    <div class="col-sm-6 pppkDetails" style="display:none">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="golongan_akhir_pppk" id="golongan_akhir_pppk">
                                ...
                                @for ($i = 5; $i <= 12; $i++)
                                    <option value="{{ $i }}" {{ old('golongan_akhir_pppk',$pegawaiData->golongan_akhir_pppk) == $i ? 'selected' : '' }}>{{ $i }}</option>
                                @endfor
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="cpns_type" id="cpns_type">
                                ...
                                <option value="PNS Provinsi" {{ old('cpns_type',$pegawaiData->cpns_type) == 'PNS Provinsi' ? 'selected' : '' }}>PNS Provinsi</option>
                                <option value="PNS Kota" {{ old('cpns_type',$pegawaiData->cpns_type) == 'PNS Kota' ? 'selected' : '' }}>PNS Kota</option>
                                @error('cpns_type')
                                <div class="text-danger">
                                    <span>{{ $message }}</span>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('virtual_asn_card',$pegawaiData->virtual_asn_card) }}" name="virtual_asn_card" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('skck_number',$pegawaiData->skck_number) }}" name="skck_number" type="text"
                    ...
                    <div class="col-sm-6 pnsDetails">
                        <div class="form-group">
                            ...
                            <input value="{{ old('sk_cpns_date',$pegawaiData->sk_cpns_date) }}" name="sk_cpns_date" type="date"
                    ...
                    <div class="col-sm-6 pnsDetails">
                        <div class="form-group">
                            ...
                            <input value="{{ old('tmt_cpns',$pegawaiData->tmt_cpns) }}" name="tmt_cpns" type="date"
                    ...
                    <div class="col-sm-6 pnsDetails">
                        <div class="form-group">
                            ...
                            <input value="{{ old('pns_sk_number',$pegawaiData->pns_sk_number) }}" name="pns_sk_number" type="text"
                    ...
                    <div class="col-sm-6 pnsDetails">
                        <div class="form-group">
                            ...
                            <input value="{{ old('sk_pns_date',$pegawaiData->sk_pns_date) }}" name="sk_pns_date" type="date"
                    ...
                    <div class="col-sm-6 pnsDetails">
                        <div class="form-group">
                            ...
                            <input value="{{ old('tmt_pns',$pegawaiData->tmt_pns) }}" name="tmt_pns" type="date"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('kepangkatan',$pegawaiData->kepangkatan) }}" name="kepangkatan" type="text"
                    ...
                    <div class="col-sm-6" id="golongan_awal_pns">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="golongan_awal" id="golongan_awal">
                                <option value="" selected disabled>Pilih Golongan Awal</option>
                                <option value="I-A" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'I-A' ? 'selected' : '' }}>I-A</option>
                                <option value="I-B" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'I-B' ? 'selected' : '' }}>I-B</option>
                                <option value="I-C" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'I-C' ? 'selected' : '' }}>I-C</option>
                                <option value="I-D" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'I-D' ? 'selected' : '' }}>I-D</option>
                                <option value="II-A" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'II-A' ? 'selected' : '' }}>II-A</option>
                                <option value="II-B" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'II-B' ? 'selected' : '' }}>II-B</option>
                                <option value="II-C" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'II-C' ? 'selected' : '' }}>II-C</option>
                                <option value="II-D" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'II-D' ? 'selected' : '' }}>II-D</option>
                                <option value="III-A" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'III-A' ? 'selected' : '' }}>III-A</option>
                                <option value="III-B" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'III-B' ? 'selected' : '' }}>III-B</option>
                                <option value="III-C" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'III-C' ? 'selected' : '' }}>III-C</option>
                                <option value="III-D" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'III-D' ? 'selected' : '' }}>III-D</option>
                                <option value="IV-A" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'IV-A' ? 'selected' : '' }}>IV-A</option>
                                <option value="IV-B" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'IV-B' ? 'selected' : '' }}>IV-B</option>
                                <option value="IV-C" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'IV-C' ? 'selected' : '' }}>IV-C</option>
                                <option value="IV-D" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'IV-D' ? 'selected' : '' }}>IV-D</option>
                                <option value="IV-E" {{ old('golongan_awal',$pegawaiData->golongan_awal) == 'IV-E' ? 'selected' : '' }}>IV-E</option>
                                @error('golongan_awal')
                                <div class="text-danger">
                                    <span>{{ $message }}</span>
                                </div>
                    ...
                    <div class="col-sm-6" id="golongan_akhir_pns">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="golongan_akhir" id="golongan_akhir">
                                <option value="" selected disabled>Pilih Golongan Akhir</option>
                                <option value="I-A" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'I-A' ? 'selected' : '' }}>I-A</option>
                                <option value="I-B" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'I-B' ? 'selected' : '' }}>I-B</option>
                                <option value="I-C" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'I-C' ? 'selected' : '' }}>I-C</option>
                                <option value="I-D" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'I-D' ? 'selected' : '' }}>I-D</option>
                                <option value="II-A" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'II-A' ? 'selected' : '' }}>II-A</option>
                                <option value="II-B" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'II-B' ? 'selected' : '' }}>II-B</option>
                                <option value="II-C" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'II-C' ? 'selected' : '' }}>II-C</option>
                                <option value="II-D" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'II-D' ? 'selected' : '' }}>II-D</option>
                                <option value="III-A" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'III-A' ? 'selected' : '' }}>III-A</option>
                                <option value="III-B" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'III-B' ? 'selected' : '' }}>III-B</option>
                                <option value="III-C" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'III-C' ? 'selected' : '' }}>III-C</option>
                                <option value="III-D" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'III-D' ? 'selected' : '' }}>III-D</option>
                                <option value="IV-A" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'IV-A' ? 'selected' : '' }}>IV-A</option>
                                <option value="IV-B" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'IV-B' ? 'selected' : '' }}>IV-B</option>
                                <option value="IV-C" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'IV-C' ? 'selected' : '' }}>IV-C</option>
                                <option value="IV-D" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'IV-D' ? 'selected' : '' }}>IV-D</option>
                                <option value="IV-E" {{ old('golongan_akhir',$pegawaiData->golongan_akhir) == 'IV-E' ? 'selected' : '' }}>IV-E</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('tmt_golongan',$pegawaiData->tmt_golongan) }}" name="tmt_golongan" type="date"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('mk_year',$pegawaiData->mk_year) }}" name="mk_year" type="text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ old('mk_month',$pegawaiData->mk_month) }}" name="mk_month" type="Text"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="data_instansi_id" id="data_instansi_id" >
                                ...
                                <option value="{{ $dataInstansi->id }}" {{ old('data_instansi_id',$pegawaiData->data_instansi_id) == $dataInstansi->id ? 'selected' : ''}}>{{ $dataInstansi->name }}</option>
                                @endforeach
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="kpkn_id" >
                                ...
                                <option value="{{ $dataKpkn->id }}" {{ old('kpkn_id',$pegawaiData->kpkn_id) == $dataKpkn->id ? 'selected' : ''}}>{{ $dataKpkn->name }}</option>
                                @endforeach
                                @error('kpkn_id')
                                <div class="text-danger">
                                    <span>{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-select mb-0" name="work_location_id" >
                                ...
                                <option value="{{ $dataWorkLocation->id }}" {{ old('work_location_id',$pegawaiData->work_location_id) == $dataWorkLocation->id ? 'selected' : ''}}>{{ $dataWorkLocation->name }}</option>
                                @endforeach
